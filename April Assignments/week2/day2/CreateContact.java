...
public class CreateContact {
	...
	public static void main(String[] args) throws IOException{
		...
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Saheel");
		...
		driver.findElement(By.id("updateContactForm_importantNote")).sendKeys("Testleaf Interns");
